...
# to do
- メモリーム
  - 日記には個人情報が入るので Gemini は辞める。Gemini を使っているところも LiteLLM の OpenRouter (deepseek/deepseek-v3.2-speciale) にして安全設定にする。(https://chatgpt.com/share/69594d43-cc50-8005-b46b-631b905ca477)
  - プロファイリング機能を入れたので動かしてみる
