...
- [ ] T006 [US1] Add E2E scenario for register + search in `tests/e2e/scenarios/minirag_demo_ui.spec.js`
...
- [ ] T010 [US2] Extend E2E scenario with delete checks in `tests/e2e/scenarios/minirag_demo_ui.spec.js`
