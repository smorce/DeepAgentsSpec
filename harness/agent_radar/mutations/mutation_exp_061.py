...
MUTATION_ID = "EXP-061"
MUTATION_TITLE = "[anthropic_engineering] FeaturedQuantifying infrastructure noise in agentic coding evalsInfrastructure configuration can swing agentic coding benchmarks by several percentage points—sometimes more than the leaderboard gap between top models."
MUTATION_SOURCE = "anthropic_engineering"
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_061"
    return item
