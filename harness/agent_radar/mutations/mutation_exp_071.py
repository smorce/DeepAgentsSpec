...
MUTATION_ID = "EXP-071"
MUTATION_TITLE = "[anthropic_engineering] Desktop Extensions: One-click MCP server installation for Claude DesktopJun 26, 2025"
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_071"
    return item
