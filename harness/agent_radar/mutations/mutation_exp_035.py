...
MUTATION_ID = "EXP-035"
MUTATION_TITLE = "[hugging_face] Community Evals: Because we're done trusting black-box leaderboards over the community"
MUTATION_SOURCE = "hugging_face"
THEMES = ["mcp", "skills", "evals", "observability"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_035"
    return item
