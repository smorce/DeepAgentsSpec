...
MUTATION_ID = "EXP-067"
MUTATION_TITLE = "[anthropic_engineering] Beyond permission prompts: making Claude Code more secure and autonomousOct 20, 2025"
MUTATION_SOURCE = "anthropic_engineering"
THEMES = ["mcp", "skills", "safety"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_067"
    return item
