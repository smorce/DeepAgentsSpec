...
MUTATION_ID = "EXP-004"
MUTATION_TITLE = "[qwen] GSPO: Towards Scalable Reinforcement Learning for Language Models"
MUTATION_SOURCE = "qwen"
THEMES = ["mcp", "skills", "scalability", "observability"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_004"
    return item
