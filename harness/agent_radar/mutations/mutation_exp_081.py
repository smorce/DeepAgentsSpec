...
MUTATION_ID = "EXP-081"
MUTATION_TITLE = "[anthropic_engineering] Building a C compiler with a team of parallel Claudes ([anthropic.com](https://www.anthropic.com/engineering/building-c-compiler))"
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_081"
    return item
