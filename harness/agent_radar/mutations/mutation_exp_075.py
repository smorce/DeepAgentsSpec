...
MUTATION_ID = "EXP-075"
MUTATION_TITLE = "[anthropic_engineering] Raising the bar on SWE-bench Verified with Claude 3.5 SonnetJan 06, 2025"
MUTATION_SOURCE = "anthropic_engineering"
THEMES = ["mcp", "skills", "evals"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_075"
    return item
