...
MUTATION_ID = "EXP-024"
MUTATION_TITLE = "[sakana_ai] Extending the Context of Pretrained LLMs by Dropping Their Positional Embeddings"
MUTATION_SOURCE = "sakana_ai"
THEMES = ["mcp", "skills", "context"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_024"
    return item
