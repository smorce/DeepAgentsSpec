...
MUTATION_ID = "EXP-031"
MUTATION_TITLE = "[hugging_face] OpenEnv in Practice: Evaluating Tool-Using Agents in Real-World Environments"
MUTATION_SOURCE = "hugging_face"
THEMES = ["mcp", "skills", "environment", "evals", "observability"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_031"
    return item
