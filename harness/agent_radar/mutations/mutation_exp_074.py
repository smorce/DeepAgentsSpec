...
MUTATION_ID = "EXP-074"
MUTATION_TITLE = "[anthropic_engineering] The \"think\" tool: Enabling Claude to stop and think in complex tool use situationsMar 20, 2025"
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_074"
    return item
