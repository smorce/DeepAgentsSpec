...
MUTATION_ID = "EXP-017"
MUTATION_TITLE = "[qwen] Qwen2.5-1M: Deploy Your Own Qwen with Context Length up to 1M Tokens"
MUTATION_SOURCE = "qwen"
THEMES = ["mcp", "skills", "context", "observability"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_017"
    return item
