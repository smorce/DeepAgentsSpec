...
MUTATION_ID = "EXP-079"
MUTATION_TITLE = "[hugging_face] DenseR: Dense Rewards For Free in LLM Reasoning ([huggingface.co](https://huggingface.co/blog/hbXNov/denser?utm_source=openai))"
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_079"
    return item
