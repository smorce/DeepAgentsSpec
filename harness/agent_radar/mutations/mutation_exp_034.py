...
MUTATION_ID = "EXP-034"
MUTATION_TITLE = "[hugging_face] Nemotron ColEmbed V2: Raising the Bar for Multimodal Retrieval with ViDoRe V3’s Top Model"
MUTATION_SOURCE = "hugging_face"
THEMES = ["mcp", "skills", "evals", "context", "observability"]
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_034"
    return item
