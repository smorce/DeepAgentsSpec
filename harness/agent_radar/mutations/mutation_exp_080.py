...
MUTATION_ID = "EXP-080"
MUTATION_TITLE = "[openai_developers] Shell + Skills + Compaction: Tips for long-running agents that do real work ([developers.openai.com](https://developers.openai.com/blog/skills-shell-tips/))"
MUTATION_SOURCE = "openai_developers"
...
def mutate(new_item):
    ...
    item['mutation_module'] = "mutation_exp_080"
    return item
